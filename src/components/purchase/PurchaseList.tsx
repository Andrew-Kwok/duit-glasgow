...
export default function PurchaseList() {
    ...
    return (
        <div className="m-8 min-h-screen">
            ...
            <div className="grid grid-cols-[repeat(auto-fill,minmax(20rem,1fr))] gap-4 my-4 max-w-full">
                <div className="card bg-base-100 w-96 max-w-full shadow-xl min-h-56">
                ...
                {purchaseList.map((purchase, index) => (
                    <div className="card bg-base-100 w-96 max-w-full shadow-xl" key={index}>
                        <div className="card-body">
                            ...
                            <div>
                                <h1 className="text-2xl font-bold"> {purchase.currency} {purchase.total_amount.toFixed(2)} </h1>
                            </div>
